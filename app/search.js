...
const Search = () => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <View className='bg-indigo-900 h-48 items-center justify-center'>
                <Text className='font-semibold text-2xl text-white'>Search for a Product</Text>
            </View>
            <View className='w-4/4 justify-center px-8'>
                <TextInput className='rounded-lg shadow-lg px-6 py-4 -mt-8 bg-white' placeholder="Enter name of product"  value={name} onChangeText={setName}/>
            </View>
            <View className='items-center mt-12'>
                <Pressable className='bg-indigo-800/10 border border-indigo-400 py-2 text-center justify-center items-center rounded-lg w-fit px-10' onPress={call}>
                    <Text className='font-semibold text-sm'>Search</Text>
                </Pressable>
            </View>
            <View>
